...
g++ assembler/assembler/assembler.cpp -c
g++ assembler/general/ctype.cpp -c -std=c++11
g++ assembler/general/meta.cpp -c
g++ assembler/main.cpp -c
g++ main.o meta.o ctype.o assembler.o INinstr.o OUTinstr.o RSTinstr.o RETinstr.o CALLinstr.o JRinstr.o JPinstr.o SETinstr.o RESinstr.o BITinstr.o SRLinstr.o SLAinstr.o SRAinstr.o RRinstr.o RRCinstr.o RLinstr.o RLCinstr.o DECinstr.o INCinstr.o XORinstr.o CPinstr.o characterlist.o tokenlist.o lex.o bytecode.o parser.o addresslist.o foundlist.o LDinstr.o PUSHinstr.o POPinstr.o EXinstr.o ADDinstr.o ADCinstr.o SUBinstr.o SUBCinstr.o ANDinstr.o ORinstr.o -o odin.exe
del assembler.o
del INinstr.o
del OUTinstr.o
del RSTinstr.o
